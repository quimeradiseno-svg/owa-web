        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-white/5">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="flex gap-3">
              <a href="#" className="p-2.5 rounded-xl bg-white/5 border border-white/5 text-gray-400 hover:text-owa-sky hover:bg-white/10 hover:border-owa-sky/20 transition-all cursor-pointer">
