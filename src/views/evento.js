...
const barraDatos = (e, esChallenge) => html`
...
export function render(ctx) {
  ...
  return toHTML(html`
    ...
    ${barraDatos(e, esChallenge)} ${raceState === 'vivo' ? bandaVivo() : ''}
    ${e.tipo === 'core' ? jornadas(e) : esChallenge ? requisitos() : ''}
    ...
    <div class="u-shell grid gap-4.5 pt-20 lg:grid-cols-2">
      <section class="rounded-owa-lg bg-owa-mist p-8" aria-labelledby="h-reglamento">
        ...
        <div class="mt-6">${btnPrimario('Descargar PDF', '/reglamento-owa.pdf')}</div>
      </section>
